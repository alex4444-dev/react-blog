                        ...
                        <div>
                            <article>
                                ...
                                <div className={s.entryContent}>
                                    ...
                                    <div><img src={ava} title="Авторский блог" className={s.ava} /></div>

                                    <p></p>
                                    <p><strong style={{ color: '#235713' }}>Дата рождения: </strong> 1982г<br /></p>
                                    <p><strong style={{ color: '#235713' }}>Сфера деятельности: </strong> Писатель</p>
